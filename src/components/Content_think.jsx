...
export default function Content_think(props) {
  ...
  const content= new Map([
    ...
    [1, "Because I tend to think things through carefully, I always try to make decisions that bring the most benefit.<br>I make sure to gather as much relevant information as possible, look for patterns or benefit, and use them to guide my choices. That’s why every decision I make tends to be <i>data-informed</i>  — backed by clear reasons and something I can stand by (and you can count on me to stand by it, too).<br>When I’m gathering information, understanding the <i>why</i> behind everything is also one of my main goals. It helps me see what’s really going on and why it's happening. That curiosity also makes me more adaptive , because when I understand the cause, I can respond better and choose the best decisions. Even when something unexpected happens, I can usually figure out what’s different and where it came from, so I know how to adjust."],
    [2, "Sometimes, I get really focused on a small piece of data. I can spend hours just looking at one part, trying to find as many insights as possible. But that’s not always a good thing. When I focus too much on the details, I sometimes miss the bigger picture — kind of like overfitting[^1]. So now, I try to remind myself to zoom out and see things more clearly.<br>Also, because I put so much thought into things, I tend to take more time than others. Not because I’m slow, but because I want to make sure I’m thorough and fair in how I approach things. Quality over speed, you know? Though I’m learning when to say “okay, this is good enough” and move on."]
  ]);
