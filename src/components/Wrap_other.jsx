...
export default function Wrap_other(props) {
  ...
  const data={
    ...
    1: { name: "oliv", image: "john.jpg",content:"kamu temen yang baik banget!! penuh consideration ke temen kamu. aku rasa temen-temenmu gapernah merasa ga nyaman di sekitarmu, bahkan ketika kamu marah. kamu bikin ambience yang bagus dengan orang-orang di sekitarmu. kamu peduli sama orang lain juga.",title:"" },
